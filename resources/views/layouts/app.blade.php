...
<body class="min-h-screen bg-brand-blue-dark text-brand-black antialiased">
    ...
    <a href="tel:{{ $siteSettings->get('call_phone') }}"
       class="fixed bottom-5 right-5 z-50 inline-flex h-14 items-center gap-2 rounded-chip bg-orange-500 px-5 text-base font-extrabold text-white shadow-lg transition hover:bg-orange-600 focus:outline-none focus:ring-4 focus:ring-white/50">
